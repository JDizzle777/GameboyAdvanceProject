...
const int kObj_Alien[MAX_ENEMIES] = {1, 2, 3, 4, 5};
const int kObj_Monster[MAX_ENEMIES] = {6, 7, 8, 9, 10};
const int kObj_Laser[MAX_ENEMIES] = {11, 12, 13, 14, 15};
const int kObj_playerLaser[5] = {16, 17, 18, 19, 20};
...
private:
   ...
   int playerLaserX[MAX_ENEMIES], playerLaserY[MAX_ENEMIES];

   // the direction of the lasers
   int laserDirection[MAX_ENEMIES];
   int playerLaserDir[MAX_ENEMIES];
};
